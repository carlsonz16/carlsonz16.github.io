class BarChart {
    ...
    initVis() {
      ...
      vis.xValue = d => d.urban_rural_status; // Assuming we want to categorize by urban_rural_status
      ...
      vis.tooltip = d3.select("body").append("div")
        ...
        vis.chart.append('text')
            ...
            .attr('y', 0 - vis.config.margin.left) // Positioning from the left edge of the SVG
            .attr('x', 0 - (vis.height / 2)) // Positioning along the height of the chart area
            .attr('dy', '1em') // Adjust for spacing
            .style('text-anchor', 'middle') // Center the text
            .text(vis.config.legendTitle); // Your text label
    }
    ...
    updateVis() {
      ...
      vis.chart.selectAll('.bar')
          ...
          .attr('height', d => height_fix(d)) // Correctly apply height calculation
          .attr('fill', '#69b3a2')

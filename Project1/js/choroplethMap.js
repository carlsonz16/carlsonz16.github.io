class ChoroplethMap {
  ...
  updateVis() {
    ...
    const dataPropertyValues = d3.extent(vis.data.objects.counties.geometries.filter(d => d.properties[vis.config.dataProperty] != null && d.properties[vis.config.dataProperty] >= 0), d => d.properties[vis.config.dataProperty] ? d.properties[vis.config.dataProperty] : 0);

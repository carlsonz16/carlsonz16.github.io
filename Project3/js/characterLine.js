class CharacterLineChart {
    ...
    initVis() {
        ...
        //     if (d.season.length < 2){
        //         epStr += "0" + d.season;
        //     } else {epStr += d.season;}

        //     if (d.episode.length < 2){
        //         epStr += "0" + d.epidsode;
        //     } else {epStr += d.episode;}

        //     episodeDomain.push(epStr);
        // });

        // console.log(episodeDomain);
    ...
    updateVis() {
        ...
        console.log(vis.seasonDialogues);
        
        vis.xValue = d => d.season;
        vis.yValue = d => d.dialogues;
        ...
        vis.yScale.domain(d3.extent(vis.seasonDialogues, vis.yValue));
